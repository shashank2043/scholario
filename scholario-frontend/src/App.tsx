...
import { FacultyCourses } from './features/faculty/FacultyCourses';
...
import { DepartmentsMaster } from './features/admin/DepartmentsMaster';
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/admin" element={<AdminPortal />}>
              ...
              <Route path="departments" element={<DepartmentsMaster />} />
